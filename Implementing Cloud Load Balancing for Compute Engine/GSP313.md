...
```bash
curl -LO
https://github.com/anushri-sharma/Google-Cloud-Computing-Foundations/blob/main/Implementing%20Cloud%20Load%20Balancing%20for%20Compute%20Engine/four/lab4.sh
